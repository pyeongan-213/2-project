...
@Controller
public class CrawlingWeeklyChart {

	@RequestMapping("/chart/weeklyChart")
    public String getWeeklyChart(Model model) {
        List<Song> songs = new ArrayList<>();

        try {
            String url = "https://www.melon.com/chart/week/index.htm";
        ...
        return "chart/weeklyChart"; // melonChart.jsp로 이동
    }
