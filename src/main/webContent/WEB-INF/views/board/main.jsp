...
<body onload="setCurrentBoardIdFromURL();">
		...
		<div class="board-container">
					...
					<c:forEach var='obj' items="${bestList}">
						<tbody align="center">
							<tr class="best-list-row">
								...
								<td
									style="width: 10%; text-align: left; color: gray; font-size: 14px;">♡
									${obj.like_count}</td>
							</tr>
						</tbody>
					</c:forEach>
			...
			<div>
				...
				<div class="on-table">
					...
					<span style="margin-left: auto; margin-right: 20px;"> <a
						href="${root }board/write" class="write-btn">글작성</a>
					</span>
				</div>
						...
						<c:forEach var='obj' items="${contentList}">
							<tr style="line-height: 2.0; border-bottom: 1px solid #494949">
								...
								<td style="width: 35%; text-align: left; padding: 0 20px;"><a
									href="${root}board/read?board_id=${obj.board_id }&boardpost_id=${obj.boardpost_id}"
									style="color: white;"> ${obj.content_title} </a></td>
								...
								<td style="width: 15%; color: gray; font-size: 14px;">♡
									${obj.like_count}</td>
							</tr>
						</c:forEach>
					</tbody>
			...
			<div class="fixed-content">
				<form:form id="emailForm"
					...
					<button class="send-mail" type="submit">
						<span style="font-size: 17px;">전송하기&nbsp;</span> <img
							src="${root}/img/send-icon.png" alt="메일 전송"
	...
	<div id="loading"
		style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7); z-index: 1000; text-align: center; padding-top: 20%;">
		<span class="back"> <span>S</span> <span>e</span> <span>n</span>
