				...
				<div class="quiz-room-game-center">
					...
					<!-- 게임 시작 버튼 -->
						...
						<div class="quiz-button">
						  <button class="quiz-button-main" id="quiz-button-start">
						    <svg class="quiz-star-1 star"><use xlink:href="#star" /></svg>
						    <svg class="quiz-star-2 star"><use xlink:href="#star" /></svg>
						    <svg class="quiz-star-3 star"><use xlink:href="#star" /></svg>
						    <svg class="quiz-star-4 star"><use xlink:href="#star" /></svg>
						    <svg class="quiz-star-5 star"><use xlink:href="#star" /></svg>
						    <svg class="quiz-star-6 star"><use xlink:href="#star" /></svg>
						    게임시작
						  </button>
						</div>
...
<!-- 	<div class="galaxy-button">
  <button>
    ...
    <span class="orbit-container">
      ...
      <span class="static-star"></span>
      <span class="static-star"></span>
      <span class="star-galaxy">
        <span class="star-orbit-ring">
    ...
    <span class="button-text">게임시작</span>
  </button>
