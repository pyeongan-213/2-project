...
<head>
    ...
    <script src="https://www.youtube.com/iframe_api"></script> <!-- 유튜브 API 로드 -->
        ...
        <div class="quiz-room-main">
            ...
            <div class="player-list-container">
                <div class="player-list">
                    <p>플레이어 목록</p>
                    <ul id="players"></ul> <!-- 동적으로 플레이어 목록 추가 -->
                </div>
            </div>
            ...
            <div class="quiz-room-game-center">
                ...
                <div class="quiz-room-music-icon" id="play-toggle-btn">
                    <i class="bi bi-play-circle-fill" id="play-icon"></i> <!-- 기본 아이콘 -->
                </div>

                <!-- 타이머 (재생 버튼 아래, 게임 시작 버튼 위) -->
            ...
            <div class="quiz-room-chat-section">
                <div id="chat-messages" class="quiz-room-chat-messages"></div> <!-- 채팅 메시지 -->
                <div class="quiz-room-chat-input-wrapper">
                    <input type="text" id="chat-input" class="quiz-room-chat-input" placeholder="채팅 입력..." />
