...
<link rel="stylesheet" href="${root}/css/main_main.css">
...
<body>
   <div class="container">
      <section data-bgcolor="#bcb8ad" data-textcolor="#032f35">
         <div>
            ...
            <p data-scroll data-scroll-speed="2" data-scroll-delay="0.2">with
               GSAP ScrollTrigger & Locomotive Scroll</p>
         </div>
      </section>
      ...
      <section data-bgcolor="#e3857a" data-textcolor="#f1dba7">
         ...
         <h2 data-scroll data-scroll-speed="1" class="credit">
            <a href="https://thisisadvantage.com" target="_blank">Made by
               Advantage</a>
         </h2>
      </section>
   </div>
   ...
   <script
      src="https://cdnjs.cloudflare.com/ajax/libs/locomotive-scroll/4.1.1/locomotive-scroll.min.js"></script>
